    ...
    if (self.bindAnalogKeys) {
        switch (key) {
            ...
            case(KEY_Tab):
                ...
                break;
            case(KEY_LeftShift):
                [touch_controller.extendedGamepad.leftTrigger setValue:pressed ? 1.0 : 0.0];
                break;
            case(KEY_X):
            ...
            case(KEY_U):
                ...
                break;
            case(KEY_I):
                [touch_controller.extendedGamepad.buttonMenu setValue:pressed ? 1.0 : 0.0];
                break;
            case(KEY_Slash):
                [touch_controller.extendedGamepad.buttonOptions setValue:pressed ? 1.0 : 0.0];
                break;
