...
private extension JSButton {
    var buttonTag: PVSupervisionButton {
        get {
            return PVSupervisionButton(rawValue: tag)!
        }
        set {
...
final class PVSupervisionControllerViewController: PVControllerViewController<PVSupervisionSystemResponderClient> {
