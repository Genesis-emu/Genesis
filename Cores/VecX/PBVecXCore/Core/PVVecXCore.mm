...
//        char *value = strdup("pentium_slow"); // auto
    ...
    /*
     ...
     "The raw performance that VecX will try to emulate." "\n\n", NULL, //end of Performance section
     "Performance",
     {
         { "auto",    "AUTO - VecX will try to detect performance needs (default)" },
     ...
     },
     {
         ...
         "Emulation method (VecX CPU core) used.", NULL,
         "System",
         {
