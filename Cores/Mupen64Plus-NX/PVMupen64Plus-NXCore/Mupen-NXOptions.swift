...
@objc public extension PVMupen64PlusNXCore {
  @objc var dualJoystickOption: Bool { MupenGameNXCore.valueForOption(MupenGameNXCore.dualJoystickOption).asBool }
    
    @objc var controllerPak1Option: Int { MupenGameNXCore.valueForOption(MupenGameNXCore.controllerPak1).asInt ?? 1 }
    @objc var controllerPak2Option: Int { MupenGameNXCore.valueForOption(MupenGameNXCore.controllerPak2).asInt ?? 1 }
    @objc var controllerPak3Option: Int { MupenGameNXCore.valueForOption(MupenGameNXCore.controllerPak3).asInt ?? 1 }
    @objc var controllerPak4Option: Int { MupenGameNXCore.valueForOption(MupenGameNXCore.controllerPak4).asInt ?? 1 }
