...
void
InitAUPlayer(Desmume2015AUGraphPlayer *player) {
...
void
CreateMyAUGraph(Desmume2015AUGraphPlayer *player)
{
                ...
                AudioBufferList * ioData)
{
    ...
    read_ptr += inNumberFrames;
        ...
        //  Desmume2015AUGraphPlayer *player = (Desmume2015AUGraphPlayer*) inRefCon;
