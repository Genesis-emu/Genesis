...
Genesis_DIR = '/Volumes/DATA/Code/Genesis'
#Genesis_DIR = '/Users/jmattiello/Workspace/Genesis/Genesis'
...
CORE_DIR = Genesis_DIR + '/Cores/PPSSPP'
VULKAN_DIR = Genesis_DIR + '/MoltenVK'

# Relative path to Core Lib Project Directory
CORE_LIB_DIR = "../libretro_ppsspp"
